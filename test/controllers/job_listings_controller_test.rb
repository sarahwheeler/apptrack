...
class JobListingsControllerTest < ActionController::TestCase
  ...
  test "should create job_listing" do
    assert_difference('JobListing.count') do
      post :create, job_listing: { company: @job_listing.company, date_posted: @job_listing.date_posted, title: @job_listing.title, url: @job_listing.url }
    end
  ...
  test "should update job_listing" do
    patch :update, id: @job_listing, job_listing: { company: @job_listing.company, date_posted: @job_listing.date_posted, title: @job_listing.title, url: @job_listing.url }
    assert_redirected_to job_listing_path(assigns(:job_listing))
  end
